...
# 2 - In modified list swap elements with indexes 1 and 5 (1<->5). Print result
# my_list = people_records.index(1)
# print(my_list)
# k = 4
# people_records[0], people_records[k] = people_records[k], people_records[0]
# print(people_records)
...
#     car_filter.append((key, year, engine_capacity, price))
# sorted_cars = sorted(car_filter, key=lambda x: x[3])
#
# for car in sorted_cars:
#   key, year, size, cost = car
#   print(f"Car: {key}, Year: {year}, Size: {size}, Cost: {cost}")